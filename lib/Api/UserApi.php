...
class UserApi
{
     ...
     * @return \VentureLeap\UserService\Model\UserJsonldUserRead
     */
    public function userLoginUserItem($id, $body = null)
    {
        list($response) = $this->userLoginUserItemWithHttpInfo($id, $body);
        return $response;
    }

    /**
     * Operation userLoginUserItemWithHttpInfo
     *
     * Check User Credentials
     *
     * @param  string $id (required)
     ...
     * @return array of \VentureLeap\UserService\Model\UserJsonldUserRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function userLoginUserItemWithHttpInfo($id, $body = null)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->userLoginUserItemRequest($id, $body);
    ...
    /**
     * Operation userLoginUserItemAsync
     *
     * Check User Credentials
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userLoginUserItemAsync($id, $body = null)
    {
        return $this->userLoginUserItemAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userLoginUserItemAsyncWithHttpInfo
     *
     * Check User Credentials
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userLoginUserItemAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->userLoginUserItemRequest($id, $body);
    ...
    /**
     * Create request for operation 'userLoginUserItem'
     *
     * @param  string $id (required)
     * @param  \VentureLeap\UserService\Model\Credentials $body Authenticates user based on credentials (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userLoginUserItemRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling userLoginUserItem'
            );
        }
