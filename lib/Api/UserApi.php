...
class UserApi
{
    ...
    /**
     * Operation getUserByTypeItem
     *
     * Retrieves a User resource.
     *
     * @param  string $user_type user_type (required)
     ...
     * @return \VentureLeap\UserService\Model\UserJsonldUserRead
     */
    public function getUserByTypeItem($user_type, $username)
    {
        list($response) = $this->getUserByTypeItemWithHttpInfo($user_type, $username);
        return $response;
    }

    /**
     * Operation getUserByTypeItemWithHttpInfo
     *
     * Retrieves a User resource.
     *
     * @param  string $user_type (required)
     ...
     * @return array of \VentureLeap\UserService\Model\UserJsonldUserRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserByTypeItemWithHttpInfo($user_type, $username)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->getUserByTypeItemRequest($user_type, $username);
    ...
    /**
     * Operation getUserByTypeItemAsync
     *
     * Retrieves a User resource.
     *
     * @param  string $user_type (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserByTypeItemAsync($user_type, $username)
    {
        return $this->getUserByTypeItemAsyncWithHttpInfo($user_type, $username)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getUserByTypeItemAsyncWithHttpInfo
     *
     * Retrieves a User resource.
     *
     * @param  string $user_type (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserByTypeItemAsyncWithHttpInfo($user_type, $username)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->getUserByTypeItemRequest($user_type, $username);
    ...
    /**
     * Create request for operation 'getUserByTypeItem'
     *
     * @param  string $user_type (required)
     * @param  string $username (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserByTypeItemRequest($user_type, $username)
    {
        // verify the required parameter 'user_type' is set
        if ($user_type === null || (is_array($user_type) && count($user_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_type when calling getUserByTypeItem'
            );
        }
        // verify the required parameter 'username' is set
        if ($username === null || (is_array($username) && count($username) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $username when calling getUserByTypeItem'
            );
        }

        $resourcePath = '/user/users/{userType}/{username}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \VentureLeap\UserService\Model\InlineResponse2001
     */
    public function getUserCollection($username = null, $email = null, $first_name = null, $last_name = null, $custom_data = null, $user_type = null, $active = null, $deleted = null, $username = null, $page = '1', $items_per_page = '10', $pagination = null)
    {
        list($response) = $this->getUserCollectionWithHttpInfo($username, $email, $first_name, $last_name, $custom_data, $user_type, $active, $deleted, $username, $page, $items_per_page, $pagination);
        return $response;
    }
     ...
     * @return array of \VentureLeap\UserService\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserCollectionWithHttpInfo($username = null, $email = null, $first_name = null, $last_name = null, $custom_data = null, $user_type = null, $active = null, $deleted = null, $username = null, $page = '1', $items_per_page = '10', $pagination = null)
    {
        $returnType = '\VentureLeap\UserService\Model\InlineResponse2001';
        $request = $this->getUserCollectionRequest($username, $email, $first_name, $last_name, $custom_data, $user_type, $active, $deleted, $username, $page, $items_per_page, $pagination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCollectionAsync($username = null, $email = null, $first_name = null, $last_name = null, $custom_data = null, $user_type = null, $active = null, $deleted = null, $username = null, $page = '1', $items_per_page = '10', $pagination = null)
    {
        return $this->getUserCollectionAsyncWithHttpInfo($username, $email, $first_name, $last_name, $custom_data, $user_type, $active, $deleted, $username, $page, $items_per_page, $pagination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCollectionAsyncWithHttpInfo($username = null, $email = null, $first_name = null, $last_name = null, $custom_data = null, $user_type = null, $active = null, $deleted = null, $username = null, $page = '1', $items_per_page = '10', $pagination = null)
    {
        $returnType = '\VentureLeap\UserService\Model\InlineResponse2001';
        $request = $this->getUserCollectionRequest($username, $email, $first_name, $last_name, $custom_data, $user_type, $active, $deleted, $username, $page, $items_per_page, $pagination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserCollectionRequest($username = null, $email = null, $first_name = null, $last_name = null, $custom_data = null, $user_type = null, $active = null, $deleted = null, $username = null, $page = '1', $items_per_page = '10', $pagination = null)
    {
    ...
    {
        list($response) = $this->postCredentialsItemWithHttpInfo($body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCredentialsItemAsync($body = null)
    {
        return $this->postCredentialsItemAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPasswordRequest
     *
     * Checks User Email is correct and sends Password reset link
     *
     * @param  \VentureLeap\UserService\Model\UserJsonldPasswordRequest $body The new User resource (optional)
     *
     * @throws \VentureLeap\UserService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\UserService\Model\UserJsonldUserRead
     */
    public function postPasswordRequest($body = null)
    {
        list($response) = $this->postPasswordRequestWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation postPasswordRequestWithHttpInfo
     *
     * Checks User Email is correct and sends Password reset link
     *
     * @param  \VentureLeap\UserService\Model\UserJsonldPasswordRequest $body The new User resource (optional)
     ...
     * @return array of \VentureLeap\UserService\Model\UserJsonldUserRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPasswordRequestWithHttpInfo($body = null)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->postPasswordRequestRequest($body);
    ...
    /**
     * Operation postPasswordRequestAsync
     *
     * Checks User Email is correct and sends Password reset link
     *
     * @param  \VentureLeap\UserService\Model\UserJsonldPasswordRequest $body The new User resource (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPasswordRequestAsync($body = null)
    {
        return $this->postPasswordRequestAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postPasswordRequestAsyncWithHttpInfo
     *
     * Checks User Email is correct and sends Password reset link
     *
     * @param  \VentureLeap\UserService\Model\UserJsonldPasswordRequest $body The new User resource (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPasswordRequestAsyncWithHttpInfo($body = null)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->postPasswordRequestRequest($body);
    ...
    /**
     * Create request for operation 'postPasswordRequest'
     *
     * @param  \VentureLeap\UserService\Model\UserJsonldPasswordRequest $body The new User resource (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postPasswordRequestRequest($body = null)
    {

        $resourcePath = '/user/users/request-password';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\UserService\Model\UserJsonldMfaRequest',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function requestMfaCodeUserItemRequest($id, $body = null)
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling requestMfaCodeUserItem'
            );
        }

        $resourcePath = '/user/users/{id}/request-mfa-code';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation validateMfaCodeUserItem
     *
     * Creates a User resource.
     *
     * @param  string $id id (required)
     * @param  \VentureLeap\UserService\Model\UserJsonldMfaCheck $body The new User resource (optional)
     *
     * @throws \VentureLeap\UserService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VentureLeap\UserService\Model\UserJsonldUserRead
     */
    public function validateMfaCodeUserItem($id, $body = null)
    {
        list($response) = $this->validateMfaCodeUserItemWithHttpInfo($id, $body);
        return $response;
    }

    /**
     * Operation validateMfaCodeUserItemWithHttpInfo
     *
     * Creates a User resource.
     *
     * @param  string $id (required)
     ...
     * @return array of \VentureLeap\UserService\Model\UserJsonldUserRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function validateMfaCodeUserItemWithHttpInfo($id, $body = null)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->validateMfaCodeUserItemRequest($id, $body);
    ...
    /**
     * Operation validateMfaCodeUserItemAsync
     *
     * Creates a User resource.
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateMfaCodeUserItemAsync($id, $body = null)
    {
        return $this->validateMfaCodeUserItemAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation validateMfaCodeUserItemAsyncWithHttpInfo
     *
     * Creates a User resource.
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateMfaCodeUserItemAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\VentureLeap\UserService\Model\UserJsonldUserRead';
        $request = $this->validateMfaCodeUserItemRequest($id, $body);
    ...
    /**
     * Create request for operation 'validateMfaCodeUserItem'
     *
     * @param  string $id (required)
     * @param  \VentureLeap\UserService\Model\UserJsonldMfaCheck $body The new User resource (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function validateMfaCodeUserItemRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling validateMfaCodeUserItem'
            );
        }

        $resourcePath = '/user/users/{id}/check-mfa-code';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
