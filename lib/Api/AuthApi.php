...
class AuthApi
{
     ...
     * @return \VentureLeap\UserService\Model\Auth
     */
     ...
     * @throws \VentureLeap\UserService\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VentureLeap\UserService\Model\Auth, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCredentialsItemWithHttpInfo($body = null)
    {
        $returnType = '\VentureLeap\UserService\Model\Auth';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VentureLeap\UserService\Model\Auth',
